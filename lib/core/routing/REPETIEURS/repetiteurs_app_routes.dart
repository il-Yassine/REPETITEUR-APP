...
final Map<String, WidgetBuilder> teachers_routs = {
  ...
  TeacherAddingInformationScreen.routeName: (context) => const TeacherAddingInformationScreen(),
  TeacherForgotPasswordScreen.routeName: (context) => const TeacherForgotPasswordScreen(),
  AddingInfoSuccessScreen.routeName: (context) => const AddingInfoSuccessScreen(),
  ...
  TeacherBibliothequeScreen.routeName: (context) => const TeacherBibliothequeScreen(),
  TeacherAdminResponseScreen.routeName: (context) => const TeacherAdminResponseScreen(),
