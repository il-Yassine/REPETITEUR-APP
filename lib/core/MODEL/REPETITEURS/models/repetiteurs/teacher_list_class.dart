...
class TeacherList {
  ...
  static Future<List<Teachers>> getAllTeacher({String? communeName, String? cycle, String? disponibilite}) async {
    ...
    const allTeachersUrl = 'https://www.api-mon-encadreur.com/api/repetiteurs?traitementDossiers=Validé';
  ...
  static Future<List<Teachers>> getAllTeacherWithoutEvaluation({String? communeName, String? cycle, String? disponibilite}) async {
    ...
    const allTeachersUrl = 'https://www.api-mon-encadreur.com/api/repetiteurs';
  ...
  static Future<List<Teachers>> getTeachersByCommune({String? communeName, String? cycle, String? disponibilite}) async {
    try {
      ...
      final response = await http.get(Uri.parse('http://www.api-mon-encadreur.com/api/repetiteurs?name=$communeName'));
  ...
  static Future<List<Communes>> getAllCommunes() async {
    const allCommunesUrl = 'http://www.api-mon-encadreur.com/api/communes';
  ...
  static Future<List<Classes>> getAllClasses() async {
    const allClassesUrl = 'http://www.api-mon-encadreur.com/api/classes';
  ...
  static Future<List<Matieres>> getAllMatieres() async {
    const allMatieresUrl = 'http://www.api-mon-encadreur.com/api/matieres';
