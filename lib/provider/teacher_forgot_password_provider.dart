...
import 'package:repetiteur_mobile_app_definitive/MODULES/PARTIE_REPETITEURS/modules/screens/authentication/forgot_password/teacher_forgot_password_email_sent.dart';
...
class TeacherForgotPasswordProvider extends ChangeNotifier {
  ...
  void sendEmailForResetPassword(
    ...
    var passwordResetUrl =
        Uri.https(requestBaseUrl, '/api/auth/password/email');
    ...
    try {
      ...
      if (response.statusCode == 201 || response.statusCode == 200) {
        ...
        PageNavigator(ctx: context)
            .nextPageOnly(page: const TeacherPasswordResetMailSent());
      } else {
